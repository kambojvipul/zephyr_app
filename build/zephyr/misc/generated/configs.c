...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x150000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SAMPLE_INTERVAL_MS, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_ENABLE_BLE, 1);
